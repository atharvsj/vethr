...
//   const [bankData, setBankData] = useState({
//     account_title: '', account_number: '', bank_name: '', iban: '', bank_branch: ''
//   });
...
//               { label: "Bank Name", name: "bank_name" }, { label: "IFSC Code", name: "iban" },
//               { label: "Bank Branch", name: "bank_branch", full: true },
//             ].map((field) => (
...
//     });
//     const [contactData, setContactData] = useState({
//         contact_full_name: '', contact_phone_no_1: '', contact_phone_no_2: '', contact_email: '', contact_address: ''
//     });
//     const [otherData, setOtherData] = useState({
//         uan_number: '',
//         pf_no: '',
...
//                     break;
//                 case 4:
//                     setContactData(data || { contact_full_name: '', contact_phone_no_1: '', contact_phone_no_2: '', contact_email: '', contact_address: '' });
//                     break;
//                 case 5:
//                     setOtherData({
...
//                                 value={contactData.contact_phone_no_1 || ''}
//                                 onChange={(e) => handleChange(e, setContactData)}
//                                 fullWidth
//                                 required
//                                 type="tel"
