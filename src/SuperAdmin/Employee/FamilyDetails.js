...
//     const userId = 50; // As specified in the API URL
//     const apiUrl = `https://tdtlworld.com/hrms-backend/api/family-members-user/${userId}/`;
...
//         id: result.data.family_member_id,
//         name: result.data.name,
//         age: result.data.age,
//         relation: result.data.relation,
//         occupation: result.data.occupation,
//         dob: result.data.date_of_birth, // use the format from API
//       };
...
// // Make sure your route is defined with the ':user_id' parameter, e.g., <Route path="/family-details/:user_id" ... />
...
//       // CORRECTED: Check for user_id before fetching data.
//       if (!id) {
//         console.error("User ID is missing from the URL. Cannot fetch family members.");
//         return;
//       }

//       // CORRECTED: Use user_id in the API URL.
...
//         // Map API data to the format used by the table state
...
//     fetchFamilyMembers();
//   }, [id]); // CORRECTED: Re-run effect if user_id changes
...
//     // CORRECTED: Use the dynamic user_id from the URL
//     if (!id) {
//         Swal.fire({
//             icon: 'error',
//             title: 'Error',
