...
const formatTime = (timeString) => {
  // If time is null, '00:00:00', or '00:00', return the desired replacement
  ...
  try {
    ...
    return '--'; // Return replacement on any formatting error
  }
};
      ...
      <TableBody>
        {paginatedData.map((row) => (
          <TableRow key={row.id}>
            ...
            {/* --- UPDATED CELLS USING THE NEW HELPER FUNCTION --- */}
