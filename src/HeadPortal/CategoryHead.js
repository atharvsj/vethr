...
const CategoryHead = () => {
  ...
  return (
    <Box p={3}>
      {/* Page Header */}
      <Typography variant="h6" fontWeight="bold" gutterBottom color="#8C257C">
        List All <Typography component="span" color="#F58E35">Categories</Typography>
      </Typography>

      {/* Top Bar with Rows per Page & Search */}
      <Box
        mb={2}
        display="flex"
      ...
      <TableContainer component={Paper} elevation={2}>
        ...
        {/* Bottom Section with Total Rows (Left) and Pagination (Right) */}
        <Box
          display="flex"
          justifyContent="space-between"
          alignItems="center"
