...
// //   const [unreadCount, setUnreadCount] = useState(0); // <-- STEP 1: State for unread count
...
// //         setUnreadCount(formattedMessages.length); // <-- STEP 2: Set initial count
// //       } catch (error) {
...
// //     setUnreadCount(0); // Reset count when the menu is opened
// //   };
...
// //             {/* --- Use the unreadCount state for the badge --- */}
...
// //         // --- START: NEW LOGIC FOR PERSISTENT COUNT ---
// //         // 1. Get the last count the user saw from localStorage. Default to 0 if not found.
// //         const lastViewedCount = parseInt(localStorage.getItem('viewedNotificationCount') || '0', 10);
        
// //         // 2. The number of unread notifications is the difference.
// //         const newUnreadCount = formattedMessages.length - lastViewedCount;

// //         // 3. Set the badge count, ensuring it's not a negative number.
...
// //     };
// //     fetchNotifications();
// //   }, [userId, empid]); // Added empid to dependency array for correctness
...
// //     // This becomes the new baseline for "viewed".
...
// import { Link } from "react-router-dom"
// import adminlogo from "./admin-logo.jpeg"
// import CloseIcon from "@mui/icons-material/Close"; // 1. Import the CloseIcon
...
//       {/* 2. UPDATE THE "MY ACCOUNT" DRAWER */}
//       <Drawer
//         anchor="right"
...
//               p: '12px 8px 12px 16px', // Padding top/bottom, left/right
//             }}
//           >
//             {/* This empty IconButton is a spacer to help center the title perfectly */}
...
//           setProfilePicture(response.data.data); // Set the profile picture from the API response
//         }
//       } catch (error) {
...
//         if (response.data && response.data.status === 'success' && response.data.data) {
//           // *** FIX APPLIED HERE ***
//           // Ensure the URL is HTTPS to prevent mixed content issues.
...
//           {/* --- MODIFIED SECTION FOR LOGO BACKGROUND --- */}
//           <Box sx={{
//               backgroundColor: '#fff', 
//               borderRadius: '8px',      
//               p: '4px',                 
...
//               alt="Profile Picture" 
//               src={profilePicture} 
//               sx={{ backgroundColor: "#fff", border: "2px solid #fff" }}
//             />
//             <Box sx={{ ml: 1.5 }}>
//               <Typography variant="subtitle2" sx={{ lineHeight: 1.3, fontWeight: 'bold' }}>
//                 {userName}
