...
// import { useState, useEffect } from "react"
// import { Box, Typography, TextField, Button, Tabs, Tab, FormControl, InputLabel, Select, MenuItem, CircularProgress, Grid, Stack, Alert } from "@mui/material"
// import axiosInstance from "../utils/axiosInstance";
...
//     esic_number: "",
//     pf_number: "",
//     uan_number: "", // UAN Number state
//     ifsc_code: "",
//     swift_code: ""  // Swift Code state
//   });
//   const [emergencyContact, setEmergencyContact] = useState({
//     contact_full_name: "",
//     contact_phone_no: "",
...
//     // Mapping UI tab index to the API's 'type' parameter
//     const apiTypeMap = { 0: 1, 1: 2, 2: 3, 3: 4, 4: 6 };
//     const type = apiTypeMap[selectedTab];
...
//             case 3: setBankAccount(details); break;
//             case 4: setEmergencyContact(details); break;
//             case 6: setOtherDetails(details); break;
//             default: break;
//           }
//         }
//       } catch (error) {
...
//   const handleBankChange = createChangeHandler(setBankAccount);
//   const handleEmergencyChange = createChangeHandler(setEmergencyContact);
//   const handleOtherDetailsChange = createChangeHandler(setOtherDetails);
...
//                 <Grid item xs={12} sm={6}><TextField name="uan_number" label="UAN Number" value={bankAccount.uan_number || ''} onChange={handleBankChange} fullWidth /></Grid>
//                 <Grid item xs={12} sm={6}><TextField name="ifsc_code" label="IFSC Code" value={bankAccount.ifsc_code || ''} onChange={handleBankChange} fullWidth /></Grid>
//                 <Grid item xs={12} sm={6}><TextField name="swift_code" label="Swift Code" value={bankAccount.swift_code || ''} onChange={handleBankChange} fullWidth /></Grid>
//                 {/* =================================================================== */}
...
//             <Grid container spacing={2} sx={{ mt: 1 }}>
//                 <Grid item xs={12} sm={6}><TextField name="passport_no" label="Passport Number" value={otherDetails.passport_no || ''} onChange={handleOtherDetailsChange} fullWidth /></Grid>
//                 <Grid item xs={12} sm={6}><TextField name="vehicle_no" label="Vehicle Number" value={otherDetails.vehicle_no || ''} onChange={handleOtherDetailsChange} fullWidth /></Grid>
//                 <Grid item xs={12} sm={6}><TextField name="driving_licence_no" label="Driving Licence Number" value={otherDetails.driving_licence_no || ''} onChange={handleOtherDetailsChange} fullWidth /></Grid>
//                 <Grid item xs={12} sm={6}><TextField name="aadhar_no" label="Aadhar Number" value={otherDetails.aadhar_no || ''} onChange={handleOtherDetailsChange} fullWidth /></Grid>
//             </Grid>
//             <ActionButtons onSave={() => handleUpdate(6, otherDetails)} />
//           </Box>
//         );
//       default:
//         return null;
