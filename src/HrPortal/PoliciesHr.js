...
// Analytics
// int Analytics_ID
// string Health_Metrics
// string Progress
// string Trends
// Security
// int Security_ID
// bool Data_Encrypted
// date Last_Security_Update
...
//                   hover
//                   sx={{ cursor: 'pointer' }}
//                   onClick={() => handleOpenPdf(row.content, row.title)}
//                 >
//                   <TableCell>
//                     <Box sx={{ display: 'flex', alignItems: 'center' }}>
...
//         }}>
//           <Typography>Showing 1 to 3 of 3 records</Typography>
...
export default function PoliciesHr() {
