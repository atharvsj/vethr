...
// //     navigate(`/hrms/dashboardLM/marks/${id}`);
// //   };
...
// // export default PerformanceTableLM;
...
//                 edge="start"
//                 color="inherit"
//                 onClick={() => navigate("/hrms/dashboardLM/performanceTable/")}
//                 sx={{ mr: 2 }}
//               >
//                 <ArrowBackIcon />
//               </IconButton>
...
// export const PerformanceTableLM = () => {
//     const navigate = useNavigate();
...
//       navigate(`/hrms/dashboardLM/marks/${selectedRow.id}`, {
//         state: {
...
//                 <Toolbar>
//                     <IconButton edge="start" color="inherit" onClick={() => navigate("/hrms/dashboardLM/confirmation")} sx={{ mr: 2 }} >
//                         <ArrowBackIcon />
//                     </IconButton>
//                     <Typography variant="h6" sx={{ flexGrow: 1, fontWeight: 600 }}>
//                         Employee Performance - ID: {id}
...
//         navigate(`/hrms/dashboardLM/marks/${row.id}`, {
...
//             <AppBar position="static" sx={{ backgroundColor: "#8C257C", color: "#FFFFFF" }}>
//                 <Toolbar>
//                     <IconButton edge="start" color="inherit" onClick={() => navigate("/hrms/dashboardLM/performanceTable")} sx={{ mr: 2 }} >
//                         <ArrowBackIcon />
//                     </IconButton>
//                     <Typography variant="h6" sx={{ flexGrow: 1, fontWeight: 600 }}>
//                         Employee Performance - ID: {id}
...
const OverallAnalysis = ({ userId, employeeVId }) => {
    ...
    return (
        <Box>
            ...
            {/* UPDATED: Removed action buttons and will always display status */}
            <Box display="flex" justifyContent="center" mt={3}>
                <Alert severity="info" sx={{ width: 'fit-content' }}>
