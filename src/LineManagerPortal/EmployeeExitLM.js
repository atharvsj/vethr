...
import ExitQuestionLM from './ExitQuestionLM';
import ReturnAssetLM from './ReturnAssetLM';
import CleanranceFormLM from './CleanranceFormLM';
...
const cardPanels = [
  { title: 'Exit Interview', description: 'Provide feedback on your experience', icon: <QuestionAnswerIcon fontSize="large" sx={{ color: primaryPurple }} />, component: <ExitQuestionLM /> },
  { title: 'Return Asset', description: 'Confirm your returned assets', icon: <AssignmentReturnIcon fontSize="large" sx={{ color: primaryPurple }} />, component: <ReturnAssetLM /> },
  { title: 'Clearance Form', description: 'Download your clearance document', icon: <DescriptionIcon fontSize="large" sx={{ color: primaryPurple }} />, component: <CleanranceFormLM /> },
];
