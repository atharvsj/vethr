...
//   if (!timeString || timeString.startsWith("00:00")) {
//     return "--";
//   }
...
// // Converts "HH:MM" or "00:00" into readable duration or "--"
...
//             <TableCell>
//               <Typography variant="body1" fontWeight="medium">{row.employee_name}</Typography>
//               <Typography variant="body2" color="textSecondary">{row.employee_email}</Typography>
//             </TableCell>
//             <TableCell>{row.attendance_date}</TableCell>
//             <TableCell>
...
//             <TableCell>{row.late_mark}</TableCell>
//             <TableCell>{formatDuration(row.early_mark)}</TableCell>
//             <TableCell>{formatDuration(row.total_work)}</TableCell>
//           </TableRow>
//         ))}
//       </TableBody>
//     );
...
//     <Box sx={{ mt: 2 }}>
//       <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
//         <Typography variant="h4" fontWeight="bold">Today's Attendance</Typography>
//       </Box>
...
//                 <TableCell sx={{ fontWeight: 'bold' }}>HALF DAY</TableCell>
...
//   try {
//     const [hours, minutes] = timeString.split(":");
//     // Ensure parts are valid numbers before formatting
...
// // --- NEW HELPER FUNCTION TO FIX THE ISSUE ---
// // Converts "Y" or "N" to "Yes" or "No"
...
//       <TableBody>
//         {paginatedData.map((row) => (
//           <TableRow key={row.id || row.attendance_date} sx={{ '&:hover': { backgroundColor: '#f5f5f5' } }}>
//             <TableCell>
//               <Typography variant="body1" fontWeight="medium">{row.employee_name}</Typography>
//               <Typography variant="body2" color="textSecondary">{row.email}</Typography>
//             </TableCell>
...
//             {/* --- FIX APPLIED HERE --- */}
//             <TableCell>{formatYesNo(row.late_mark)}</TableCell>
//             <TableCell>{formatYesNo(row.is_half_day)}</TableCell>
...
//   TextField, Alert, TablePagination, Skeleton, useTheme, useMediaQuery, InputAdornment
// } from '@mui/material';
...
//       <TableBody>
//         {paginatedData.map((row) => (
//           <TableRow key={row.id || row.attendance_date} sx={{ '&:hover': { backgroundColor: '#f5f5f5' } }} style={{ fontSize: '0.95rem' }}>
//             <TableCell>
//               <Typography variant="body2" fontWeight="medium">{row.employee_name}</Typography>
...
//               <TableCell sx={{ fontWeight: 'bold', color: 'white' }}>PUNCH IN</TableCell>
//               <TableCell sx={{ fontWeight: 'bold', color: 'white' }}>PUNCH OUT</TableCell>
//               <TableCell sx={{ fontWeight: 'bold', color: 'white' }}>LATE</TableCell>
//               <TableCell sx={{ fontWeight: 'bold', color: 'white' }}>HALF DAY</TableCell>
//               <TableCell sx={{ fontWeight: 'bold', color: 'white' }}>TOTAL WORK</TableCell>
//             </TableRow>
//           </TableHead>
//           {renderTableContent()}
//         </Table>
