...
// //           <Button variant="contained" startIcon={<AddIcon />} sx={{ bgcolor: 'primary', '&:hover': { bgcolor: '#5e35b1' }, textTransform: 'none' }} onClick={onShowCreateView}>Create Ticket</Button>
// //         </Paper>
// //         {renderTicketList()}
// //       </Grid>
...
//           sx={{
//             backgroundColor: 'primary',
//             '&:hover': { backgroundColor: '#e8e7eaaa' },
//             textTransform: 'none',
//             fontSize: '1rem',
//             padding: '8px 24px',
//             minWidth: '150px'
...
const TicketDashboard = ({ tickets, onTicketSelect, onShowCreateView, loading, error }) => {
  ...
  return (
    <Grid container spacing={3}>
      <Grid item xs={12} lg={8}>
        <Paper elevation={0} sx={{ p: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
          <Typography variant="h5" fontWeight="bold" color= "#8C257C">Tickets List</Typography>
          <Button
            variant="contained"
            startIcon={<AddIcon />}
            sx={{
      ...
      <Grid item xs={12} lg={4}>
        <Paper elevation={0} sx={{ p: 2, mb: 3, height: '350px' }}>
          <Typography variant="h5" fontWeight="bold" color= "#8C257C" sx={{ mb: 2 }}>Ticket Priority</Typography>
          <Box sx={{ height: 'calc(100% - 48px)' }}>
            <Pie data={priorityData} options={chartOptions} />
          </Box>
        </Paper>
        <Paper elevation={0} sx={{ p: 2, height: '350px' }}>
          <Typography variant="h5" fontWeight="bold" color= "#8C257C" sx={{ mb: 2 }}>Ticket Status</Typography>
          <Box sx={{ height: 'calc(100% - 48px)' }}>
            <Doughnut data={statusData} options={chartOptions} />
          </Box>
        </Paper>
