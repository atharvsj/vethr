...
// import ExitQuestionEmp from './ExitQuestionEmp';
// import ReturnAssetEmp from './ReturnAssetEmp';
// import ClearenceFormEmp from './ClearenceFormEmp';
...
// const cardPanels = [
//   { title: 'Exit Interview', description: 'Provide feedback on your experience', icon: <QuestionAnswerIcon fontSize="large" sx={{ color: primaryPurple }} />, component: <ExitQuestionEmp /> },
//   { title: 'Return Asset', description: 'Confirm your returned assets', icon: <AssignmentReturnIcon fontSize="large" sx={{ color: primaryPurple }} />, component: <ReturnAssetEmp /> },
//   { title: 'Clearance Form', description: 'Download your clearance document', icon: <DescriptionIcon fontSize="large" sx={{ color: primaryPurple }} />, component: <ClearenceFormEmp /> },
// ];
...
// export default EmployeeExitComponent;
