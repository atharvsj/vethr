...
//   const handleDownloadPDF = async () => {
//     // ✅ OPTIMIZATION: Reduced scale for smaller canvas size
//     const scale = 2; 
//     const canvas1 = await html2canvas(formRef1.current, { scale });
//     const canvas2 = await html2canvas(formRef2.current, { scale });

//     // ✅ OPTIMIZATION: Use JPEG with a quality setting (0.7 = 70%) for smaller image size
...
//     // ✅ OPTIMIZATION: Add image as JPEG and apply fast compression
//     pdf.addImage(imgData1, "JPEG", 10, 10, imgWidth, imgHeight1, undefined, 'FAST');
//     pdf.addPage();
//     pdf.addImage(imgData2, "JPEG", 10, 10, imgWidth, imgHeight2, undefined, 'FAST');
//     pdf.save("Employee_Clearance_Form.pdf");
//   };
...
//       try {
//         const response = await fetch("https://tdtlworld.com/hrms-backend/api/get_employee_details_clearance_form/?user_id=494");
...
//                 <td>{employeeData?.department_name || ''}</td>
//               </tr>
//               <tr>
...
//               </tr>
//               <tr>
//                 <td className="info-label">Resignation Date:</td>
//                 <td>{employeeData?.resignation_date}</td>
//               </tr>
//               <tr>
//                 <td className="info-label">Relieving Date:</td>
//                 <td>{employeeData?.relieving_date}</td>
//               </tr>
//               <tr>
//                 <td className="info-label">Line Manager:</td>
//                 <td>{employeeData?.line_manager_name}</td>
//               </tr>
//             </tbody>
//           </table>
//           <div className="section-title">CLEARANCE FROM DEPT HEAD</div>
        ...
        <div ref={formRef1} className="form-container">
          ...
          <table className="form-table info-table">
            <tbody>
              ...
              <tr>
                <td className="info-label">Division:</td>
                <td>{employeeData?.division_name || ''}</td>
              </tr>
              <tr>
                <td className="info-label">Headquarter:</td>
                <td>{employeeData?.headquarter_name || ''}</td>
              </tr>
              {/* End of new fields */}
              <tr>
                <td className="info-label">Joining Date:</td>
